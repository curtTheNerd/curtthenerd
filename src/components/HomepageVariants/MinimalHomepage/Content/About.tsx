    ...
    <div className="w-full flex py-4">
      <div className="flex flex-col justify-center">
        <p>
          ...
          time you spent to read about me! <br /> Once I - born and raised on
          the outskirts of the medieval German "Thüringer" forest - decided to
          become the first technological wizard of my kind.
          ...
          and Supervisor in Construction & Assembly (2018 - 2023) before I
